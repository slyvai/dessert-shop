...
const Cart = ({ items, onRemoveFromCart,setCartItems}) => {
            ...
            <div className="container-item">
                {items.map((item, index) => (
                    <div className="cart-item" key={index}>
                            ...
                            <h1>{item.name}</h1>
                            <span className="quantity">{item.quantity}x</span> <span className="prices">@ ${item.price.toFixed(2)}</span> <span className="total">${(item.price * item.quantity).toFixed(2)}</span>
                        ...
                        <p>Order Total </p> <span className="order-total">${total.toFixed(2)}</span>
                        </div>
                        <div className="carbon-things">
                    ...
                    <div>
                    <button onClick={confirmOrder} className="button-confirm">Confirm Order</button>
                    </div>
            </div>
        )}
    </div>
