...
const Cart = ({ items, onRemoveFromCart}) => {
  ...
  return (
    <div className="container-cart">
        <ConfirmOrder isOpen={isNotificationOpen} cartData={cartData} onClose={() => setIsNotificationOpen(false)} />
            ...
            <div>
                {items.map((item, index) => (
                    <div className="cart-item" key={index}>
                        ...
                        <b>Order Total </b> <span className="order-total">${total.toFixed(2)}</span>
                        </div>
                    <div>
