        ...
        <div className="notification-overlay">
            <div className="notification-content">
                ...
                <div className="notification-body">
                        ...
                        {items.map((item, index) => (
                            <li key={index}>
                                ...
                                <div className="items-details">
                                    ...
                                    <span className="quantity-1">{item.quantity}x </span> <span className="price-1">@${item.price}</span>  <span className="total-1">${item.price.toFixed(2)}</span>
                    ...
                    <button className="button-order" onClick={handleClose}>Start New Order</button>
